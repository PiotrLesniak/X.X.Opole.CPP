Module Module1
    Sub Main()
        ...
        Dim x = AggLookup("max", (int)1,4,5);


    End Sub

Function MAX(ByVal val1 As Integer, ByVal val2 As Integer, ByVal val3 As Integer, ByVal val4 As Integer, ByVal val5 As Integer, ByVal val6 As Integer, ByVal val7 As Integer,)
